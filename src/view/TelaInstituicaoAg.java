 ...
 * @author diegu
 */
public class TelaInstituicaoAg extends javax.swing.JFrame {

    /**
     * Creates new form TelaPrincipal
     */
    public TelaInstituicaoAg() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaInstituicaoAg.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaInstituicaoAg().setVisible(true);
            }
        });
    }
